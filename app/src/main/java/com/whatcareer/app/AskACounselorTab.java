...
public class AskACounselorTab extends Fragment{
    ...
    private Toast toast;
    View view;
    EditText name, email, phone, subject, message, ambition, course, m_occupation, f_occupation, personality;
    ...
    public void submitResponse()
    {
        ...
        level = (Spinner) getActivity().findViewById(R.id.level_c);
        ambition = (EditText) getActivity().findViewById(R.id.ambition_c);
        course = (EditText) getActivity().findViewById(R.id.course_c);
        m_occupation = (EditText) getActivity().findViewById(R.id.m_occupation_c);
        f_occupation = (EditText) getActivity().findViewById(R.id.f_occupation_c);
        personality = (EditText) getActivity().findViewById(R.id.personality_c);
        ...
        if(ambition.getText().toString().trim().isEmpty())
        {
            ambition.setError("Empty Field", getResources().getDrawable(R.drawable.ic_error_black_24dp));
            ambition.getBackground().setColorFilter(getResources().getColor(R.color.edittext_background_error), PorterDuff.Mode.SRC_ATOP);
            err = true;
        }
        if(course.getText().toString().trim().isEmpty())
        {
            course.setError("Empty Field", getResources().getDrawable(R.drawable.ic_error_black_24dp));
            course.getBackground().setColorFilter(getResources().getColor(R.color.edittext_background_error), PorterDuff.Mode.SRC_ATOP);
            err = true;
        }
        if(personality.getText().toString().trim().isEmpty())
        {
            personality.setError("Empty Field", getResources().getDrawable(R.drawable.ic_error_black_24dp));
            personality.getBackground().setColorFilter(getResources().getColor(R.color.edittext_background_error), PorterDuff.Mode.SRC_ATOP);
            err = true;
        }
            ...
            try {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                    ...
                    protected Map<String, String> getParams()
                    {
                        ...
                        params.put("m_occupation",m_occupation.getText().toString().trim());
                        params.put("f_occupation",f_occupation.getText().toString().trim());
    ...
    public void cleanFields()
    {
        ...
        ambition.setText("");
        course.setText("");
        m_occupation.setText("");
        f_occupation.setText("");
        personality.setText("");
    }
    ...
    public void clearError()
    {
        ...
        ambition.getBackground().setColorFilter(getResources().getColor(R.color.edittext_background), PorterDuff.Mode.SRC_ATOP);
        course.getBackground().setColorFilter(getResources().getColor(R.color.edittext_background), PorterDuff.Mode.SRC_ATOP);
        personality.getBackground().setColorFilter(getResources().getColor(R.color.edittext_background), PorterDuff.Mode.SRC_ATOP);
    }
